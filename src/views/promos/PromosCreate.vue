  ...
  <div>
    <breadcrumb-row>
      <a-breadcrumb style="margin: 10px 5px" slot="links">
        <a-breadcrumb-item>
          <router-link to="/promos/list" test-attr="prev-link-promos">{{ $t('promos') }}</router-link>
        </a-breadcrumb-item>
    ...
    <a-row class="edit-btns">
      <a-col :span="24" style="padding: 15px 0">
        <a-form-model-item>
          <a-button :loading="btnLoading" type="primary" html-type="submit" @click.prevent="submit" test-attr="save-promos">
            {{ $t('save') }}
          </a-button>
          <a-button style="margin-left: 10px;" @click.prevent="resetForm" test-attr="reset-promos">
            {{ $t('reset') }}
          </a-button>
        </a-form-model-item>
      </a-col>
