  ...
  <div>
    <a-row>
      <a-col :span="12">
        <a-breadcrumb style="margin: 10px 5px">
          <a-breadcrumb-item>
            <router-link to="/staff/list" test-attr="prev-link-staff">{{ $t('staff') }}</router-link>
          </a-breadcrumb-item>
    ...
    <a-row>
      <a-col :span="24" style="padding: 15px 0">
        <a-form-model-item>
          <a-button :loading="btnLoading" type="primary" html-type="submit" @click.prevent="submit" test-attr="save-staff">
            {{ $t('save') }}
          </a-button>
          <a-button style="margin-left: 10px;" @click.prevent="resetForm" test-attr="reset-staff">
            {{ $t('reset') }}
          </a-button>
        </a-form-model-item>
      </a-col>
